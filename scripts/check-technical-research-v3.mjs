...
if(process.argv.includes('--chat')) {
  const records=JSON.parse(await readFile('test-results/technical-research-live-v3.json','utf8'));
...
for(const identity of identities) {
 ...
 await writeFile('test-results/technical-research-live-v3.json',JSON.stringify(results,null,2));
}
